...
impl JoyStickDevice {
    unsafe fn new(
        ...
        let mut cap = DIDEVCAPS {
            dwSize: size_of::<DIDEVCAPS>() as u32,
            ..Default::default()
        };

        di.GetCapabilities(&mut cap as *mut DIDEVCAPS)?;
...
```
NULL is null: true
get hinstance HINSTANCE(140701651697664)
DIRECT VERSION: 800
IID: BF798031-483A-4DA2-AA99-5D64ED369700
created!
start to enum attached keyboard devices
device acquired
#000 Wireless Controller:Wireless Controller, poll required: false
        #000 Z 旋转
        #001 Z 轴
        #002 Y 轴
        #003 X 轴
